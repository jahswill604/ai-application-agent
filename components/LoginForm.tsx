    ...
    <div className="w-full max-w-[420px] mx-auto flex flex-col justify-center px-8 lg:px-10">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-[14px]">
          Sign in to manage your job applications with AI.
        </p>
      </div>
      ...
      <div className="flex items-center my-5">
        ...
        <span className="px-3 text-[11px] text-gray-400 bg-white">or continue with email</span>
        <div className="flex-1 border-t border-gray-200"></div>
      </div>
      ...
      <form onSubmit={handleEmailLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-2.5 px-4 bg-[#0a0a0a] hover:bg-[#1a1a1a] text-white text-[14px] font-medium rounded-lg transition-colors disabled:opacity-50 mt-2"
        >
          Sign in
        </button>
      </form>
