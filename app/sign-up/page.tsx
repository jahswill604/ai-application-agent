  ...
  return (
    <div className="min-h-screen flex font-sans bg-black">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white h-screen overflow-y-auto py-12">
        <div className="w-full max-w-[480px] mx-auto flex flex-col justify-center px-8 lg:px-10">
          {success ? (
            <div className="text-center">
              ...
              <h2 className="text-[32px] font-bold text-gray-900 tracking-tight mb-2">Check your email</h2>
              ...
              <Link
                href="/"
                className="w-full block py-3 px-4 bg-[#0a0a0a] hover:bg-[#1a1a1a] text-white text-[15px] font-medium rounded-lg transition-colors text-center"
              >
                Back to sign in
              </Link>
            </div>
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-4 py-3 border border-gray-200 rounded-lg text-[15px] font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50"
              >
              ...
              <div className="flex items-center my-6">
                ...
                <span className="px-3 text-[12px] text-gray-400 bg-white">or sign up with email</span>
                <div className="flex-1 border-t border-gray-200"></div>
              </div>
              ...
              <form onSubmit={handleSignUp} className="space-y-5" noValidate>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-3 bg-[#eef2fc] border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white text-[15px]"
                    required
                    disabled={loading}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 bg-[#0a0a0a] hover:bg-[#1a1a1a] text-white text-[15px] font-medium rounded-lg transition-colors disabled:opacity-50 mt-2 cursor-pointer"
                >
